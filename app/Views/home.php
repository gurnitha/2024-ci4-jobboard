...
<?= $this->section('content'); ?>
        ...
        <section class="py-5 bg-image overlay-primary fixed overlay" id="next" style="background-image: url(<?= base_url ('public/assets/images/hero_1.jpg'); ?>">
            <div class="container">
        ...
        <section class="py-5 bg-image overlay-primary fixed overlay" style="background-image: url(<?= base_url ('public/assets/images/hero_1.jpg'); ?>">
            <div class="container">
